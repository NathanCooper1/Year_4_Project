...
ax[1].axvline(x=1000,ymin=0.,ymax=1,c="blue",linewidth=0.5)  
ax[1].axvline(x=2000,ymin=0.,ymax=1,c="blue",linewidth=0.5)  
ax[1].set_xlim((0,3000))
ax[1].set_title('Target')
#plt.figure()
y1=mlab.normpdf(x,1000, sigma1)+mlab.normpdf(x,2000, sigma1)
ax[2].plot(x,y1)
plt.xlim((0,3000))
